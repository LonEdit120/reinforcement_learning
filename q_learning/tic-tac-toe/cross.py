...
def update(winner,preKey,curKey):
    # print('Xs preKey : ' + str(preKey))
    # print('Xs curKey : ' + str(curKey))
    ...
    if (not exist):
        ...
        preScore = 0
        # print('bugged : X preKey ' + str(preKey) + ' not found===========')
...
def toFile():
    ...
    print('Cross train data successfully imported to crossTrainData.txt !')
